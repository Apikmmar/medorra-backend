...
def lambda_handler(event, context: LambdaContext):
    try:
        ...
        updateSymptom(item, currentVersion)

        return createResponse(200, "Symptom entry updated successfully", item)
...
@tracer.capture_method
def updateSymptom(item, currentVersion):
    dynamoRetry(
        SYMPTOMS_TABLE.put_item,
        Item=item,

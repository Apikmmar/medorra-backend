...
# from .event_bridge_stack import EventBridgeStack  # TODO: Enable when Pattern Analysis Lambda is built (task 7)
...
class MedorraBackendStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, prefix: str, **kwargs) -> None:
        ...
        # TODO: Enable when Pattern Analysis Lambda is built (task 7)
